...
aleatorio_par = random.randrange(2,11,2)  # Número par del 2 al 10 (incluido)
aleatorio_impar = random.randrange(1,10,2)  # Número impar del 1 al 9 (incluido)
